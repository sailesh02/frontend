...
import { getLocaleLabels, getTransformedLocale, getQueryArg } from "egov-ui-framework/ui-utils/commons";
...
const resubmitScrutiny = (state, dispatch) => {
    ...
    let applicantName = scrutinyObj && scrutinyObj.planDetail.planInformation.applicantName;
    let serviceType = scrutinyObj && scrutinyObj.planDetail.planInformation.serviceType;
...
export const scrutinySummaryForHistory = getCommonGrayCard({
                    ...
                    children: {
                        occupancyType: getLabelWithValue(
                            ...
                            },
                            {
                                ...
                                jsonPath: "scrutinyDetailsForHistory.planDetail.occupancies[0].typeHelper.type.code",
                                callBack: checkValueForNA
                            }
                        ),
                    }
            ...
            demolitionDetailsContainer: getCommonContainer({
                demolitionArea: getLabelWithValue(
                    ...
                    {
                        jsonPath: "scrutinyDetailsForHistory.planDetail.planInformation.demolitionArea",
                        callBack: value => {
                            if (value) { return value; }
                            else if (value == "0") { return "0" }
                            else { return checkValueForNA }
            ...
            totalBuildUpAreaDetailsContainer: getCommonContainer({
                buitUpArea: getLabelWithValue(
                    ...
                    {
                        jsonPath: "scrutinyDetailsForHistory.planDetail.virtualBuilding.totalBuitUpArea",
                        callBack: checkValueForNA
                    }
                ),
                totalFloors: getLabelWithValue(
