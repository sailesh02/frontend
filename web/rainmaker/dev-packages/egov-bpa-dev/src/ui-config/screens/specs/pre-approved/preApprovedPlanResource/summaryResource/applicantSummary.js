  ...
  body: getCommonContainer({
    institutionType: getLabelWithValue(
      ...
      },
      {
        ...
        callBack: (value) => {
          return (
            `COMMON_MASTERS_OWNERSHIPCATEGORY_${getTransformedLocale(value)}` ||
            checkValueForNA
          );
        },
      }
    ...
    institutionName: getLabelWithValue(
      ...
      {
        jsonPath: "BPA.landInfo.additionalDetails.institutionName",
        callBack: checkValueForNA,
      }
    ),
    telephoneNumber: getLabelWithValue(
      ...
      {
        jsonPath: "BPA.landInfo.additionalDetails.telephoneNumber",
        callBack: checkValueForNA,
      }
    ),
    ...
    designation: getLabelWithValue(
      ...
      {
        jsonPath: "BPA.landInfo.additionalDetails.institutionDesignation",
        callBack: checkValueForNA,
      }
    ),
