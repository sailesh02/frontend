import {
  ...
  import { permitConditions } from "./preApprovedPlanResource/summaryResource/permitConditions";
  import { permitListSummary } from "./preApprovedPlanResource/summaryResource/permitListSummary";
  import {
    downloadFeeReceipt,
  ...
  import { citizenFooter, updateBpaApplication, updateBpaApplicationAfterApproved } from "../egov-bpa/searchResource/citizenFooter";
  import { applicantSummary, institutionSummary } from "./preApprovedPlanResource/summaryResource/applicantSummary";
  import { basicSummary } from "./preApprovedPlanResource/summaryResource/basicSummary";
  import { declarationSummary } from "./preApprovedPlanResource/summaryResource/declarationSummary";
  import { estimateSummary } from "./preApprovedPlanResource/summaryResource/estimateSummary";
  import { sanctionFeeSummary } from "./preApprovedPlanResource/summaryResource/sanctionFeeSummary";
  import { fieldinspectionSummary } from "./preApprovedPlanResource/summaryResource/fieldinspectionSummary";
  import { fieldSummary } from "./preApprovedPlanResource/summaryResource/fieldSummary";
  import { reviewPdfSignDetails } from './preApprovedPlanResource/summaryResource/review-pdfSign.js'
  import { previewSummary } from "./preApprovedPlanResource/summaryResource/previewSummary";
  import { scrutinySummary ,commentsContainer, commentsContainerMultiLine, getEdcrHistory, scrutinySummaryForHistory} from "./preApprovedPlanResource/summaryResource/scrutinySummary";
  import { nocDetailsSearchBPA} from "../egov-bpa/noc";
  import store from "ui-redux/store";
  import commonConfig from "config/common.js";
  import { getPaymentSearchAPI } from "egov-ui-kit/utils/commons";
  import { additionalDocsInformation } from "./preApprovedPlanResource/documentDetails";
  import { sanctionFeeAdjustmentDetails } from "./preApprovedPlanResource/sanctionFeeAdjustmentDetails";
