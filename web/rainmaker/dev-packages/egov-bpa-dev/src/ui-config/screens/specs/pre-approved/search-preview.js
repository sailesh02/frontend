...
import {
  ...
  nocapplicationUpdateBPA,
  getStakeHolderRoles,
} from "../../../../ui-utils/commons";
import "./preApprovedPlanResource/index.css";
...
import {
  ...
  updateBpaApplicationAfterApproved,
...
import {
  scrutinySummary,
  commentsContainer,
  commentsContainerMultiLine,
  getEdcrHistory,
  scrutinySummaryForHistory,
} from "./preApprovedPlanResource/summaryResource/scrutinySummary";
...
const setSearchResponse = async (
  ...
  await getDrawingDetails(state,dispatch,true);
