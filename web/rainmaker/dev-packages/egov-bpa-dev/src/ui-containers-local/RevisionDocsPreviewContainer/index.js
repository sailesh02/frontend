...
import RevisionMultiDocDetailCard from "../../ui-molecules-local/RevisionMultiDocDetailCard";
import UploadCard from "../../ui-molecules-local/UploadCard";
import "./index.css";


class RevisionDocsPreviewContainer extends Component {
  state = {
    uploadedDocIndex: 0,
...
const mapStateToProps = (state, ownProps) => {
  ...
  const finalCardsforPreview = get(
    ...
    "RvsndocumentDetailsPreview",
    []
  );
  

  return { finalCardsforPreview };
};
