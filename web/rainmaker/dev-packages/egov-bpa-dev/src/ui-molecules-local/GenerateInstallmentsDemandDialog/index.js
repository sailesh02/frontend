...
import {bpaMakeInstallmentPayment} from "../../ui-config/screens/specs/egov-bpa/searchResource/citizenFooter";
//import "./index.css";
...
class ActionDialog extends React.Component {
  ...
  render() {
    ...
    onClose = () => {
      ...
      store.dispatch(
        handleField("view-installments", "components.div.children.sendToArchPickerDialog", "props.open", false)
      );
    ...
    updateTheApplication = async() => {
      bpaMakeInstallmentPayment();
    }
    // updateTheApplication_BK = async() => {
    ...
    //       get(response, "BPA[0].businessService") === "BPA_OC1" ||
    //       get(response, "BPA[0].businessService") === "BPA_OC2" ||
        ...
        >
          ...
          <Grid item sm="12">
            ...
            <UploadMultipleFiles
              ...
              jsonPath={`InstallmentsDocs.varificationDocuments`}
              maxFileSize={5000}
            />
