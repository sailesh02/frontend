...
class DescriptionDashboard extends React.Component {
    ...
    customColumnSort = (colData, unchangeColData, noOfColumns) => {
        // debugger
        const data = colData;
        var indexingData = []
        //var indexCol = [0,1,2,3,4,5,7,8,9,10,11,12,13]
        var indexCol = noOfColumns
        // for(var i=0; i<indexCol.length; i++){
        //     indexingData.push(colData[indexCol[i]])
        // }

        for (var i = 0; i < indexCol; i++) {
            indexingData.push(colData[i])
        }

        const data2 = unchangeColData;
        var indexingData2 = []
        //var indexCol2 = [0,1,2,3,4,5,7,8,9,10,11,12,13]
        var indexCol2 = noOfColumns;
        // for(var i=0; i<indexCol2.length; i++){
        //     indexingData2.push(unchangeColData[indexCol2[i]])
        // }
        for (var i = 0; i < indexCol2; i++) {
            indexingData2.push(unchangeColData[i])
        }
    ...
    componentDidMount() {
        ...
        if ((JSON.stringify(this.props.data) !== JSON.stringify(this.state.checkData)) &&
            dataProps.reportData !== undefined) {
            const sortBy = sortByProp.value;
            // const sortBy = "source";
            // const sortBy = "department";
            const reportHeader = dataProps.reportHeader;
            ...
            for (var i = 0; i < reportHeader.length; i++) {
                ...
                //col["show"]= (i === 0 || i === 2 || i === 3 || i === 4 || i === 5 || i === 7 || i === 11 ) ? true : false
                col["show"] = true
                columnData.push(col)
            }
    ...
    componentDidUpdate() {
        ...
        if ((JSON.stringify(this.props.data) !== JSON.stringify(this.state.checkData)) &&
            ...
            // const sortBy = "source";
            // const sortBy = "department";
            let reportHeader = dataProps.reportHeader;
