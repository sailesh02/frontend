...
//   return <div className="application-no-container"><LabelContainer labelName="License No." labelKey ={"MR_LICENSE_NO_CODE"} dynamicArray={[licenseNumber]}/></div>;
//   }
// else
  return <div className="application-no-container"><LabelContainer labelName="Application No." labelKey ={"MR_APPLICATION_NO_CODE"} dynamicArray={[number]}/></div>;
}
