...
import { addComponentJsonpath, getQueryArg } from "egov-ui-framework/ui-utils/commons";
import { prepareFinalObject as pFO } from "egov-ui-framework/ui-redux/screen-configuration/actions";
import isEqual from "lodash/isEqual";
import LabelConatiner from "egov-ui-framework/ui-containers/LabelContainer";
...
const mapStateToProps = state => {
  ...
  let Licenses = get(preparedFinalObject, "Licenses");
  console.log(Licenses, "Nero licss")
