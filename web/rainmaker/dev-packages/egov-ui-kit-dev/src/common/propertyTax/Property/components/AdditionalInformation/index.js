...
export default class AdditionalInformation extends Component {
  render() {
    ...
    const labelKeys = ["holdingTax", "lightTax", "waterTax", "drainageTax", "latrineTax", "parkingTax", "solidWasteUserCharges", "ownershipExemption", "usageExemption", "interest", "penalty","serviceTax","otherDues","pendingFrom"]
    return (
      <div>
        <Card
