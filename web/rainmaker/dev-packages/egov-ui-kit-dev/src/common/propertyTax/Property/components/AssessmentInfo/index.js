...
export const getPlotSizeInfo = (propertyDetails, editIcon) => {
  ...
  ? "" : propertyDetails.uom ? `${Math.round(!!editIcon ? propertyDetails.landArea : propertyDetails.landArea * 9)} ${propertyDetails.uom}` : `${Math.round(( !!editIcon)? propertyDetails.landArea : propertyDetails.landArea)}`;
