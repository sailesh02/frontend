...
const formConfig = {
  ...
  fields: {
    ...
    serviceTax: {
      ...
      type: "textfield",
      floatingLabelText: "PT_SERVICE_TAX",
      hintText: "PT_SERVICE_TAX_PLACEHOLDER",
      numcols: 6,
      errorMessage: "PT_SERVICE_TAX_ERRORMSG",
      errorStyle: { position: "absolute", bottom: -8, zIndex: 5 },
      maxLength: 64,
      pattern: /^([0-9][0-9]{0,49})(\.\d{1,2})?$/,
      required: true,
    ...
    otherDues: {
      ...
      type: "textfield",
      floatingLabelText: "PT_ADDITIONAL_DUES",
      hintText: "PT_ADDITIONAL_DUES_PLACEHOLDER",
      numcols: 6,
      errorMessage: "PT_ADDITIONAL_DUES_ERRORMSG",
      errorStyle: { position: "absolute", bottom: -8, zIndex: 5 },
      maxLength: 64,
      pattern: /^([0-9][0-9]{0,49})(\.\d{1,2})?$/,
      required: true,
