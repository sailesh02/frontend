...
const withoutAuthorization = (redirectionUrl) => (Component) => {
  ...
  const mapStateToProps = (state) => {
    ...
    const ulbLogo = isPublicSearch() ? msevaLogo : (userTenant.length > 0 ? get(userTenant[0], "logoId") : "https://s3.ap-south-1.amazonaws.com/pb-egov-assets/od.amritsar/logo.png");
