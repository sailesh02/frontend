    ...
    >
      ...
      >
        <Typography variant="caption">
          <LabelContainer labelName="Date" labelKey="MR_DATE_LABEL" />
        </Typography>
      ...
      >
        <Typography variant="caption">
          <LabelContainer
            ...
            labelKey="MR_CURRENT_OWNER_LABEL"
          />
        </Typography>
        <Typography
          variant="body2"
      ...
      <Grid item xs={12} sm={6} md={4} lg={3} style={{ marginTop: 15 }}>
        <Typography variant="caption">
          <LabelContainer
            labelName="Comments"
            labelKey="MR_APPROVAL_CHECKLIST_COMMENTS_LABEL"
          />
        </Typography>
        <Typography
          variant="body2"
